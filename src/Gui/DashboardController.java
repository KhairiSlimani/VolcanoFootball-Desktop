...
public class DashboardController implements Initializable {
    ...
    @FXML
    private HBox favorisBox1;
    @FXML
    private HBox favorisBox2;
    ...
    private void OpenMatch(MouseEvent event) throws IOException {
        view = new FXMLLoader().load(getClass().getResource("match/match.fxml"));
        borderPane.setCenter(view);
    ...
    private void OpenBillet(MouseEvent event)throws IOException {
        view = new FXMLLoader().load(getClass().getResource("billet/billet.fxml"));
        borderPane.setCenter(view);
    }
