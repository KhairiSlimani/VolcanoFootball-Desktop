...
public class ProduitItemController implements Initializable {
    ...
    public void ItemInfos(Produit p, FlowPane fp, JFXDialog d, StackPane c, Text t){
        dialog = d;
        container = c;
        flowPane=fp;
        produit=p;
    ...
    private void addFav(ActionEvent event) {
        ...
        fs.AjouterFavori(f);
        AlertsController.get().Alert("information","Succès","Le produit a été ajouté à votre liste des favoris!");
    }
