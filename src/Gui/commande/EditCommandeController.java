...
public class EditCommandeController implements Initializable {
    ...
    private void EditC(ActionEvent event) {
        ...
        if(control == true)
        {
            ...
            Commande c = new Commande(CommandeId,u.getId(), p.getId(), quantite, adresse); 
            System.out.println(CommandeId);
            System.out.println(u.getId());
            System.out.println(p.getId());
            System.out.println(quantite);
            CommandeService cs = new CommandeService();
            boolean test = cs.ModifierCommande(c);
    ...
    public void setInfos(Commande cm, FlowPane fp, JFXDialog d, StackPane c){
        CommandeId = cm.getId();
        dialog = d;
        container = c;
        flowPane=fp;
        tfQuantite.setText(String.valueOf(cm.getQuantite()));
